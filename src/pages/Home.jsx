    ...
    <>
      <section className="relative min-h-screen flex items-center pt-20">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 grid md:grid-cols-2 gap-16 items-center">
          <div>
            <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/20 text-amber-400 text-xs font-bold mb-6">
            ...
            <div className="flex items-center space-x-6">
              <Link
                to="/about"
                className="bg-amber-600 text-white px-8 py-4 rounded-xl font-bold hover:bg-amber-700 transition shadow-2xl"
              >
                了解背景与服务
              </Link>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <div className="w-12 h-12 bg-amber-500/10 rounded-xl flex items-center justify-center mb-6">
                <i className="fas fa-user-graduate text-amber-400 text-xl"></i>
              </div>
              <h3 className="text-xl font-bold mb-2 text-white">背景与服务</h3>
              <p className="text-slate-500 text-sm mb-6">
                了解TSE硕士背景、精算经验及安省专业保障方案。
              </p>
              <span className="text-amber-400 text-sm font-bold">进入页面 →</span>
            </Link>
            <Link
              to="/license"
              className="portal-card p-8 rounded-3xl bg-white/5 transition group"
            >
              <div className="w-12 h-12 bg-amber-500/10 rounded-xl flex items-center justify-center mb-6">
                <i className="fas fa-id-card text-amber-400 text-xl"></i>
              </div>
              <h3 className="text-xl font-bold mb-2 text-white">合规资质</h3>
              <p className="text-slate-500 text-sm mb-6">
                查看安省FSRA官方执照与iA Financial Group合作认证。
              </p>
              <span className="text-amber-400 text-sm font-bold">查看详情 →</span>
            </Link>
            <Link
              to="/contact"
              className="portal-card p-8 rounded-3xl bg-white/5 transition group"
            >
              <div className="w-12 h-12 bg-amber-500/10 rounded-xl flex items-center justify-center mb-6">
                <i className="fas fa-comment-dots text-amber-400 text-xl"></i>
              </div>
              <h3 className="text-xl font-bold mb-2 text-white">联系我</h3>
              <p className="text-slate-500 text-sm mb-6">
                获取WeChat二维码、联系方式并提交您的咨询需求。
              </p>
              <span className="text-amber-400 text-sm font-bold">立即联系 →</span>
            </Link>
          </div>
        </div>
      </section>
