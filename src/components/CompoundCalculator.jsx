  ...
  return (
    <div id="calc" className="calculator-card p-10 rounded-3xl shadow-2xl border border-white/10">
      <h3 className="text-2xl font-bold mb-6 text-white flex items-center">
        <i className="fas fa-chart-line text-amber-400 mr-3"></i>
        资产复利演算
      </h3>
      <div className="space-y-8">
        <div>
          <div className="flex justify-between mb-4 text-xs font-bold text-slate-400 uppercase tracking-widest">
            <span>初始年存入 (CAD)</span>
            <span className="text-amber-400 text-lg">${deposit.toLocaleString()}</span>
          </div>
          <input
            type="range"
            min="2000"
        ...
        <div className="pt-6 border-t border-white/5">
          ...
          <div className="text-5xl font-extrabold text-amber-400 tracking-tighter">
